...
final class Utility {
    ...
    public static void logData(String filename, String consumerTime) {
        try {
            FileOutputStream outputStream = new FileOutputStream(System.getProperty("user.dir") + "\\" + filename + ".log", true);
            byte[] strToBytes = ("\n" + consumerTime).getBytes();
